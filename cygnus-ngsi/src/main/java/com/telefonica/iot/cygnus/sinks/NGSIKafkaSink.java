...
*/
    ...
    private String buildMessage(ContextElement contextElement, String fiwareService,
        ...
        jsonObject.addProperty("id", entityId);
        jsonObject.addProperty("type", entityType);
        for (ContextAttribute contextAttribute : contextAttributes) {
            String attrName = contextAttribute.getName();
            jsonObject.add(attrName, new Gson().toJsonTree(contextAttribute));
            jsonObject.getAsJsonObject(attrName).remove("name");
        }
